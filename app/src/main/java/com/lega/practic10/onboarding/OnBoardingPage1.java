...
import com.lega.practic10.databinding.FragmentOnBoardingPage1Binding;
...
public class OnBoardingPage1 extends Fragment {
   ...
   @Override
    ...
    private void listener(){
        binding.FOP1Button.setOnClickListener(view -> {
            Navigation.findNavController(view).navigate(R.id.to_onBoardingPage2);
        });
    }
}